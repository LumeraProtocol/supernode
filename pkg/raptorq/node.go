...
// Config contains path to where symbolid files are generated by raptorq services
type Config struct {
	RqFilesDir string
}

// RawSymbolIDFile represents raw content of symbolid files generated by raptorq services
