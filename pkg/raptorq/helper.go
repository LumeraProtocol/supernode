...
func (s *raptorQServerClient) generateRQIDs(ctx context.Context, req generateRQIDsRequest) (generateRQIDsResponse, error) {
	...
	if err != nil {
		return generateRQIDsResponse{}, errors.Errorf("marshal rqID file: %w", err)
	}
	...
	buffer.Write([]byte(req.signedData))
	...
	// Create the compressed version of the RQID file
