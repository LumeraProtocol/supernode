...
func (mr *MockModuleMockRecorder) BroadcastTx(ctx, txBytes, mode any) *gomock.Call {
...
func (mr *MockModuleMockRecorder) GetTx(ctx, hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockModuleMockRecorder) SimulateTx(ctx, txBytes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
