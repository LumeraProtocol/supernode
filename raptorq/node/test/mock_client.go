...
import (
	...
	"github.com/LumeraProtocol/supernode/raptorq/node"
	"github.com/LumeraProtocol/supernode/raptorq/node/mocks"
...
func (client *Client) ListenOnEncode(returnEnc *node.Encode, returnErr error) *Client {
	client.RaptorQ.On(EncodeMethod, mock.Anything, mock.IsType([]byte{}), mock.Anything, mock.Anything).Return(returnEnc, returnErr)
	return client
}
