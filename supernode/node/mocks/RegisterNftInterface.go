...
// SendNftTicketSignature provides a mock function with given fields: ctx, nodeID, signature
func (_m *RegisterNftInterface) SendNftTicketSignature(ctx context.Context, nodeID string, signature []byte) error {
...
func (_m *RegisterNftInterface) SendSignedDDAndFingerprints(ctx context.Context, sessionID string, fromNodeID string, compressedDDAndFingerprints []byte) error {
...
func (_m *RegisterNftInterface) Session(ctx context.Context, nodeID string, sessID string) error {
