...
func NewCascadeService(supernodeAccountAddress string, lumera lumera.Client, p2pClient p2p.Client, codec codec.Codec, rqstore rqstore.Store) *CascadeService {
	return &CascadeService{
		...
		P2PClient:               p2pClient,
		SupernodeAccountAddress: supernodeAccountAddress,
	}
}
