...
import (
	...
	sctest "github.com/LumeraProtocol/supernode/supernode/node/test/storage_challenge"
...
func TestVerifyEvaluationResult(t *testing.T) {
	...
	type args struct {
		incomingEvaluationResult types.Message
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if resp, err := task.VerifyEvaluationResult(context.Background(), tt.args.incomingEvaluationResult); (err != nil) != tt.wantErr {
