...
LDFLAGS='-s -w -X github.com/LumeraProtocol/supernode/common/version.version=$(VERSION)'
BINARY_SN ?= supernode
...
gen-proto:
	...
	cd ./proto/supernode/protobuf && protoc --go_out=.. --go-grpc_out=.. --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative healthcheck_challenge.proto
...
goa-gen:
	cd ./walletnode/api && goa gen github.com/LumeraProtocol/supernode/walletnode/api/design