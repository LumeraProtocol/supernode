...
//
// HealthCheckChallenge client HTTP transport
//
// Command:
...
// Client lists the HealthCheckChallenge service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the HealthCheckChallenge service
// servers.
func NewClient(
	scheme string,
	host string,
...
// HealthCheckChallenge service getSummaryStats server.
