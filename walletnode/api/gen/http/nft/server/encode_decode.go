...
import (
	...
	nft "github.com/LumeraProtocol/supernode/walletnode/api/gen/nft"
	nftviews "github.com/LumeraProtocol/supernode/walletnode/api/gen/nft/views"
...
func EncodeRegisterTaskResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res := v.(*nftviews.Task)
		enc := encoder(ctx, w)
...
func DecodeRegisterTaskRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		var (
			taskID string
			err    error
...
func EncodeRegisterTaskError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
...
func EncodeRegisterTasksResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
...
func EncodeRegisterTasksError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
...
// nftSearch endpoint.
func DecodeNftSearchRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		var (
			artist           *string
			limit            int
		...
		}
		{
			...
			if creatorNameRaw == "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("creator_name", creatorNameRaw, "boolean"))
				}
				creatorName = v
			}
		}
		{
			...
			if artTitleRaw == "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("art_title", artTitleRaw, "boolean"))
				}
				artTitle = v
			}
		}
		...
		}
		{
			...
			if minCopiesRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("min_copies", minCopiesRaw, "integer"))
				}
				pv := int(v)
				minCopies = &pv
			}
		...
		}
		{
			...
			if maxCopiesRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("max_copies", maxCopiesRaw, "integer"))
				}
				pv := int(v)
				maxCopies = &pv
			}
		...
		}
		{
			...
			if minBlockRaw == "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("min_block", minBlockRaw, "integer"))
				}
				minBlock = int(v)
			}
		}
		...
		}
		{
			...
			if maxBlockRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("max_block", maxBlockRaw, "integer"))
				}
				pv := int(v)
				maxBlock = &pv
			}
		...
		}
		{
			...
			if isLikelyDupeRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("is_likely_dupe", isLikelyDupeRaw, "boolean"))
				}
				isLikelyDupe = &v
			}
		}
		{
			...
			if minRarenessScoreRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("min_rareness_score", minRarenessScoreRaw, "float"))
				}
				minRarenessScore = &v
			}
		}
		...
		}
		{
			...
			if maxRarenessScoreRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("max_rareness_score", maxRarenessScoreRaw, "float"))
				}
				maxRarenessScore = &v
			}
		}
		...
		}
		{
			...
			if minNsfwScoreRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("min_nsfw_score", minNsfwScoreRaw, "float"))
				}
				minNsfwScore = &v
			}
		}
		...
		}
		{
			...
			if maxNsfwScoreRaw != "" {
				...
				if err2 != nil {
					err = goa.MergeErrors(err, goa.InvalidFieldTypeError("max_nsfw_score", maxNsfwScoreRaw, "float"))
				}
				maxNsfwScore = &v
			}
		}
...
// nft endpoint.
func EncodeNftSearchError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
...
// nftGet endpoint.
func EncodeNftGetResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
...
// endpoint.
func DecodeNftGetRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		var (
			txid string
			pid  string
...
// endpoint.
func EncodeNftGetError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
...
func EncodeDdServiceOutputFileDetailResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
...
func DecodeDdServiceOutputFileDetailRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		var (
			txid string
			pid  string
...
func EncodeDdServiceOutputFileDetailError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "UnAuthorized":
			...
			if formatter != nil {
				...
				body = NewDdServiceOutputFileDetailUnAuthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
...
// EncodeDdServiceOutputFileResponse returns an encoder for responses returned
// by the nft ddServiceOutputFile endpoint.
func EncodeDdServiceOutputFileResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*nft.DDFPResultFile)
		enc := encoder(ctx, w)
		body := NewDdServiceOutputFileResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeDdServiceOutputFileRequest returns a decoder for requests sent to the
// nft ddServiceOutputFile endpoint.
func DecodeDdServiceOutputFileRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		var (
			txid string
			pid  string
		...
		payload := NewDdServiceOutputFileDownloadPayload(txid, pid, key)
		if strings.Contains(payload.Key, " ") {
			// Remove authorization scheme prefix (e.g. "Bearer")
			cred := strings.SplitN(payload.Key, " ", 2)[1]
			payload.Key = cred
...
// EncodeDdServiceOutputFileError returns an encoder for errors returned by the
// ddServiceOutputFile nft endpoint.
func EncodeDdServiceOutputFileError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "UnAuthorized":
			...
			if formatter != nil {
				...
				body = NewDdServiceOutputFileUnAuthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "NotFound":
			...
			if formatter != nil {
				...
				body = NewDdServiceOutputFileNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "InternalServerError":
			...
			if formatter != nil {
				...
				body = NewDdServiceOutputFileInternalServerErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
