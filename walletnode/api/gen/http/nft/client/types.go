...
// NewRegisterUnAuthorized builds a nft service register endpoint UnAuthorized
// error.
...
// NewDownloadUnAuthorized builds a nft service download endpoint UnAuthorized
// error.
...
// NewDdServiceOutputFileDetailUnAuthorized builds a nft service
// ddServiceOutputFileDetail endpoint UnAuthorized error.
func NewDdServiceOutputFileDetailUnAuthorized(body *DdServiceOutputFileDetailUnAuthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// NewDdServiceOutputFileUnAuthorized builds a nft service ddServiceOutputFile
// endpoint UnAuthorized error.
func NewDdServiceOutputFileUnAuthorized(body *DdServiceOutputFileUnAuthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// ValidateDdServiceOutputFileDetailUnAuthorizedResponseBody runs the
// validations defined on ddServiceOutputFileDetail_UnAuthorized_response_body
func ValidateDdServiceOutputFileDetailUnAuthorizedResponseBody(body *DdServiceOutputFileDetailUnAuthorizedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
...
// ValidateDdServiceOutputFileUnAuthorizedResponseBody runs the validations
// defined on ddServiceOutputFile_UnAuthorized_response_body
func ValidateDdServiceOutputFileUnAuthorizedResponseBody(body *DdServiceOutputFileUnAuthorizedResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
