...
func (c *Client) BuildRegisterTaskRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		taskID string
	)
	{
...
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeRegisterTaskResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
...
func (c *Client) BuildRegisterTasksRequest(ctx context.Context, v any) (*http.Request, error) {
...
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeRegisterTasksResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
...
func (c *Client) BuildNftSearchRequest(ctx context.Context, v any) (*http.Request, error) {
	scheme := c.scheme
	switch c.scheme {
	case "http":
		scheme = "ws"
...
// nftSearch server.
func EncodeNftSearchRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
...
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeNftSearchResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
...
func (c *Client) BuildNftGetRequest(ctx context.Context, v any) (*http.Request, error) {
...
// server.
func EncodeNftGetRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
...
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeNftGetResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
...
func (c *Client) BuildDdServiceOutputFileDetailRequest(ctx context.Context, v any) (*http.Request, error) {
...
func EncodeDdServiceOutputFileDetailRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*nft.DownloadPayload)
		if !ok {
...
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeDdServiceOutputFileDetailResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusUnauthorized:
			...
			err = ValidateDdServiceOutputFileDetailUnAuthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("nft", "ddServiceOutputFileDetail", err)
			}
			return nil, NewDdServiceOutputFileDetailUnAuthorized(&body)
		case http.StatusNotFound:
			var (
...
// BuildDdServiceOutputFileRequest instantiates a HTTP request object with
// method and path set to call the "nft" service "ddServiceOutputFile" endpoint
func (c *Client) BuildDdServiceOutputFileRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: DdServiceOutputFileNftPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("nft", "ddServiceOutputFile", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeDdServiceOutputFileRequest returns an encoder for requests sent to the
// nft ddServiceOutputFile server.
func EncodeDdServiceOutputFileRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*nft.DownloadPayload)
		if !ok {
			return goahttp.ErrInvalidType("nft", "ddServiceOutputFile", "*nft.DownloadPayload", v)
		}
		{
			head := p.Key
			req.Header.Set("Authorization", head)
...
// DecodeDdServiceOutputFileResponse returns a decoder for responses returned
// by the nft ddServiceOutputFile endpoint. restoreBody controls whether the
// response body should be restored after having been read.
// DecodeDdServiceOutputFileResponse may return the following errors:
//   - "UnAuthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "NotFound" (type *goa.ServiceError): http.StatusNotFound
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeDdServiceOutputFileResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("nft", "ddServiceOutputFile", err)
			}
			err = ValidateDdServiceOutputFileResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("nft", "ddServiceOutputFile", err)
			}
			res := NewDdServiceOutputFileDDFPResultFileOK(&body)
			return res, nil
		case http.StatusUnauthorized:
			var (
			...
			err = ValidateDdServiceOutputFileUnAuthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("nft", "ddServiceOutputFile", err)
			}
			return nil, NewDdServiceOutputFileUnAuthorized(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateDdServiceOutputFileNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("nft", "ddServiceOutputFile", err)
			}
			return nil, NewDdServiceOutputFileNotFound(&body)
		case http.StatusInternalServerError:
			var (
			...
			err = ValidateDdServiceOutputFileInternalServerErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("nft", "ddServiceOutputFile", err)
			}
			return nil, NewDdServiceOutputFileInternalServerError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("nft", "ddServiceOutputFile", resp.StatusCode, string(body))
		}
	}
}
