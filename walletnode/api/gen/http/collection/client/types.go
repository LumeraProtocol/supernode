...
import (
	collection "github.com/LumeraProtocol/supernode/walletnode/api/gen/collection"
	collectionviews "github.com/LumeraProtocol/supernode/walletnode/api/gen/collection/views"
...
// NewRegisterCollectionUnAuthorized builds a collection service
// registerCollection endpoint UnAuthorized error.
func NewRegisterCollectionUnAuthorized(body *RegisterCollectionUnAuthorizedResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
...
// ValidateRegisterCollectionUnAuthorizedResponseBody runs the validations
// defined on registerCollection_UnAuthorized_response_body
func ValidateRegisterCollectionUnAuthorizedResponseBody(body *RegisterCollectionUnAuthorizedResponseBody) (err error) {
	if body.Name == nil {
