...
// collection.RegisterTaskStateClientStream interface.
...
// Recv reads instances of "collection.TaskState" from the "registerTaskState"
// endpoint websocket connection.
func (s *RegisterTaskStateClientStream) Recv() (*collection.TaskState, error) {
	var (
		rv   *collection.TaskState
