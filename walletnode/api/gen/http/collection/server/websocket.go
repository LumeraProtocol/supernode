...
// collection.RegisterTaskStateServerStream interface.
...
// Send streams instances of "collection.TaskState" to the "registerTaskState"
// endpoint websocket connection.
func (s *RegisterTaskStateServerStream) Send(v *collection.TaskState) error {
	var err error
