...
import (
	...
	"github.com/LumeraProtocol/supernode/common/service/userdata"
	"github.com/LumeraProtocol/supernode/common/storage/files"
	"github.com/LumeraProtocol/supernode/common/types"
	pb "github.com/LumeraProtocol/supernode/proto/walletnode"
...
type RegisterCollectionInterface interface {
	...
	SendTicketForSignature(ctx context.Context, ticket []byte, signature []byte, burnTxID string) (string, error)
}
...
type DownloadNftInterface interface {
	...
	Download(ctx context.Context, txid, timestamp, signature, ttxid, ttype string, hashOnly bool) ([]byte, error)
